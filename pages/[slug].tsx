...
const Subscribe = dynamic(() =>
	import('../components/subscribe').then((mod) => mod.Subscribe)
)
	...
	return (
		<>
			...
			{!post.preferences.disableComments &&
				post.comments.totalDocuments > 0 && <PostComments />}
			<Subscribe />
		</>
	)
}
...
export const getStaticProps: GetStaticProps<Props, Params> = async ({
	...
	const pageData = await request(endpoint, PageByPublicationDocument, {
		host,
		slug,
	})
